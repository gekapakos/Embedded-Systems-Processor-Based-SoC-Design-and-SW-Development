...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer is
  ...
  attribute SOFT_HLUTNM of \count[23]_i_2\ : label is "soft_lutpair64";
...
button_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
button_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
