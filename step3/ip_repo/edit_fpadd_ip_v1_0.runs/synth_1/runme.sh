...
HD_PWD='/home/inf2018/gisotirios/Desktop/Embedded/lab2/step3/ip_repo/edit_fpadd_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpadd_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpadd_ip_v1_0.tcl
